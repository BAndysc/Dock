...
// a Wrap Panel that ignores ProportionalDockSplitters
...
/// </summary>
public class ToolStripPanel : Panel, INavigableContainer
{
    /// <summary>
    /// Defines the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly StyledProperty<Orientation> OrientationProperty =
        AvaloniaProperty.Register<ToolStripPanel, Orientation>(nameof(Orientation), defaultValue: Orientation.Horizontal);

    /// <summary>
    /// Defines the <see cref="ItemWidth"/> property.
    /// </summary>
    public static readonly StyledProperty<double> ItemWidthProperty =
        AvaloniaProperty.Register<ToolStripPanel, double>(nameof(ItemWidth), double.NaN);

    /// <summary>
    /// Defines the <see cref="ItemHeight"/> property.
    /// </summary>
    public static readonly StyledProperty<double> ItemHeightProperty =
        AvaloniaProperty.Register<ToolStripPanel, double>(nameof(ItemHeight), double.NaN);

    /// <summary>
    /// Initializes static members of the <see cref="ToolStripPanel"/> class.
    /// </summary>
    static ToolStripPanel()
    {
        AffectsMeasure<ToolStripPanel>(OrientationProperty, ItemWidthProperty, ItemHeightProperty);
    }
    ...
    /// <summary>
    /// Gets or sets the width of all items in the ToolStripPanel.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the height of all items in the ToolStripPanel.
    /// </summary>
    ...
    IInputElement? INavigableContainer.GetControl(NavigationDirection direction, IInputElement? from, bool wrap)
    {
        ...
        switch (direction)
        {
            ...
            case NavigationDirection.Next:
                ++index;
                while (index < children.Count && children[index].DataContext is IProportionalDockSplitter)
                    ++index;
                break;
            case NavigationDirection.Previous:
                --index;
                while (index >= 0 && children[index].DataContext is IProportionalDockSplitter)
                    --index;
                break;
    ...
    protected override Size MeasureOverride(Size constraint)
    {
        ...
        for (int i = 0, count = children.Count; i < count; i++)
        {
            ...
            if (child.DataContext is IProportionalDockSplitter)
                continue;
